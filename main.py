    ...
    if game_state == "battle":
        ...
        if world_player.moving == False: #moving logic
            ...
            if  pygame.key.get_pressed()[pygame.K_UP]:
                ...
                if world_player.y != 0 and map[world_player.y//64-1][world_player.x//64].type != "wall":
            ...
            if  pygame.key.get_pressed()[pygame.K_DOWN]:
                player_direction = 0
                if world_player.y != 576 and map[world_player.y//64+1][world_player.x//64].type != "wall":#if not wall
                    world_player.target_y = world_player.y+64
                    world_player.moving = True
                #else:
                ...
                if world_player.x != 0 and map[world_player.y//64][world_player.x//64-1].type != "wall":#if not wall
                ...
                player_direction = 90
                if world_player.x != 576 and map[world_player.y//64][world_player.x//64+1].type != "wall":#if not wall
                    world_player.target_x = world_player.x+64
                    world_player.moving = True
               # else:
                    #print("Can't go")
